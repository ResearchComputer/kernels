...
found by ``slurm/probe_graph_beverin.sbatch``. Captures both schedules, replays,
...
Launch via SLURM srun (see slurm/bench_capture_beverin.sbatch). Reads rank/world
